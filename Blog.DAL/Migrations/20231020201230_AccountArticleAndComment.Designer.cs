...
namespace Blog.DAL.Migrations
{
    ...
    [Migration("20231020201230_AccountArticleAndComment")]
    partial class AccountArticleAndComment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blog.DAL.Entities.UserProfile", b =>
                {
                    b.HasOne("Blog.DAL.Entities.UserAccount", "UserAccount")
                        .WithOne("Profile")
                        .HasForeignKey("Blog.DAL.Entities.UserProfile", "UserAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Blog.DAL.Entities.UserAccount", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
